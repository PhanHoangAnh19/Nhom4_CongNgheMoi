            ...
            <div class="card bg-danger text-white shadow border-0">
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <div class="h3 mb-0 fw-bold">{{ $products->count() }}</div>
                    </div>
            ...
            <div class="card bg-success text-white shadow border-0">
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <div class="h3 mb-0 fw-bold">{{ $products->where('quantity', '>', 0)->count() }}</div>
                    </div>
                ...
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <div class="h3 mb-0 fw-bold">
                            {{ number_format(($products->max('price') ?? 0) / 1000000, 1) }}M
                        </div>
                    </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4">
                                @if($product->image)
                                    <img src="{{ asset($product->image) }}" class="rounded shadow-sm border" width="60" height="60" style="object-fit: cover;">
                                @else
                            ...
                            <td>
                                ...
                                <div class="text-muted small"><i class="fas fa-palette me-1"></i>Màu: {{ $product->color ?? 'Chưa cập nhật' }}</div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex flex-column gap-1">
                                    <span class="small"><i class="fas fa-memory me-1 text-secondary"></i>RAM: <strong>{{ $product->ram ?? '-' }}</strong></span>
                                    <span class="small"><i class="fas fa-hdd me-1 text-secondary"></i>ROM: <strong>{{ $product->storage ?? '-' }}</strong></span>
                                </div>
                            </td>
                            <td>
                            ...
                            <td>
                                @if($product->quantity > 0)
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="small fw-bold">{{ $product->quantity }} chiếc</span>
                                    </div>
                                @else
