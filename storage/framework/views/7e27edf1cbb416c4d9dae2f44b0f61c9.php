        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="<?php echo e(Request::is('admin/home') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(url('/admin/home')); ?>"><i class="fas fa-home"></i> Dashboard</a>
                </li>

                <div class="sidebar-heading">Cửa hàng</div>
                <li class="<?php echo e(Request::is('admin/products') ? 'active' : ''); ?>">
                    <a href="<?php echo e(url('/admin/products')); ?>"><i class="fas fa-mobile-alt"></i> Quản lý điện thoại</a>
                </li>

                <li class="<?php echo e(Request::is('admin/products/thong-ke') ? 'active' : ''); ?>">
                    <a href="<?php echo e(url('/admin/products/thong-ke')); ?>">
                ...
                <li>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url('/')); ?>" class="text-warning fw-bold">
                            <i class="fas fa-shopping-bag"></i> Xem trang Shop
                        </a>
                    <?php endif; ?>
                </li>
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm py-3">
                <div class="container-fluid">
                    <span class="navbar-text text-muted d-none d-md-block">
                        Chào mừng bạn quay lại, <strong><?php echo e(Auth::check() ? Auth::user()->name : 'Quản trị viên'); ?></strong>!
                    </span>
