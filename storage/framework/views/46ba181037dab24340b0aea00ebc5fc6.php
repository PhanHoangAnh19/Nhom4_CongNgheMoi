                ...
                <tr>
                    <td align="center" style="padding-bottom:20px;border-bottom:2px solid #007bff;">
                        <h1 style="margin:0;color:#007bff;">
                            Chào mừng đến với <?php echo e(config('app.name')); ?>!
                        </h1>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:20px 0;color:#333333;">
                        ...
                        <ul style="line-height:1.8;padding-left:20px;">
                            <li><strong>Tên:</strong> <?php echo e($user->name); ?></li>
                            <li><strong>Email:</strong> <?php echo e($user->email); ?></li>
                            <li><strong>Ngày đăng ký:</strong> <?php echo e($user->created_at->format('d/m/Y H:i')); ?></li>
                        </ul>
...
<?php /**PATH C:\xampp\htdocs\Nhom4_CongNgheMoi\resources\views/emails/welcome.blade.php ENDPATH**/ ?>