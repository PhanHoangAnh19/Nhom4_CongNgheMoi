...
<style>
    ...
    .category-spacer { height: 40px; clear: both; }
    ...
    .product-content {
        padding: 15px;
        text-align: center;
        flex-grow: 1; /* Đẩy phần nút bấm xuống đáy */
    }
    .product-brand {
        font-size: 11px;
        color: #8D99AE;
    ...
    .add-to-cart-btn:hover {
        background-color: #D10024;
        box-shadow: 0px 4px 10px rgba(209, 0, 36, 0.3);
    }
    .add-to-cart-btn i {
        margin-right: 5px;
    }
...
<?php /**PATH C:\xampp\htdocs\Nhom4_CongNgheMoi\resources\views/layouts/client.blade.php ENDPATH**/ ?>